...
const bundles = {
    ...
    main: {
        js: {
            ...
            inputFiles: [
                webroot + 'src/lib/fullpage/fullpage.min.js',
                webroot + 'src/lib/jquery/jquery-3.4.1.min.js',
                webroot + 'src/lib/simple-modal/simple-modal.js'
            ]
        },
        css: {
            outputFileName: webroot + 'dist/lib/main.min.css',
            inputFiles: [
                webroot + 'src/lib/fullpage/fullpage.css',
                webroot + 'src/lib/simple-modal/simple-modal.css'
            ]
        }
    }
};
